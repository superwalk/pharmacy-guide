...
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds001','社区获得性肺炎','呼吸系统疾病','SQHDXFY','社区环境中感染的肺实质炎症。常见病原体：肺炎链球菌、流感嗜血杆菌、肺炎支原体等。','发热、咳嗽、咳痰、胸痛、呼吸困难。','胸部X线/CT显示浸润影 + 临床症状。','经验性抗感染治疗为主，根据CURB-65评分决定治疗场所。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds002','COPD','呼吸系统疾病','COPD','慢性阻塞性肺疾病，以持续气流受限为特征的常见呼吸系统疾病。主要病因：吸烟、空气污染。','慢性咳嗽、咳痰、进行性呼吸困难。','肺功能FEV1/FVC<0.7。','戒烟+支气管扩张剂（LABA/LAMA）+吸入激素（频繁急性加重者）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds003','支气管哮喘','呼吸系统疾病','ZQGXC','以慢性气道炎症为特征的异质性疾病。特征：可变性气流受限。','反复发作性喘息、胸闷、咳嗽。','可变气流受限证据+典型症状。','按GINA阶梯方案，ICS为基础控制药物。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds004','高血压','心血管疾病','GXY','动脉血压持续升高的慢性疾病。诊断标准：非同日3次SBP≥140和/或DBP≥90mmHg。','多数无症状，部分头晕、头痛。','非同日多次测量血压升高。','生活方式干预+五大类降压药。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds005','心力衰竭','心血管疾病','XLSJ','各种心脏结构/功能异常导致心室充盈或射血能力受损的临床综合征。','呼吸困难、乏力、水肿。','BNP/NT-proBNP升高+心脏超声LVEF评估。','新四联：ARNI+β-blocker+MRA+SGLT2i。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds006','冠心病','心血管疾病','GXB','冠状动脉粥样硬化导致管腔狭窄或阻塞，心肌缺血缺氧。','胸痛（压榨性）、放射至左肩。','心电图+心肌酶+冠脉造影。','抗血小板+他汀+β-blocker±血运重建。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds007','胃溃疡','消化系统疾病','WKY','胃黏膜缺损深度超过黏膜肌层的慢性溃疡。Hp感染和NSAIDs为主要病因。','上腹痛（餐后加重）、反酸。','胃镜+病理+Hp检测。','根除Hp+PPI+胃黏膜保护剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds008','反流性食管炎','消化系统疾病','FLXSGY','胃内容物反流至食管引起的食管黏膜损伤。','烧心、反酸、胸骨后疼痛。','胃镜检查。','PPI为主，疗程4-8周。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds009','2型糖尿病','内分泌疾病','XTNB','胰岛素抵抗和/或分泌不足导致的慢性高血糖。','多饮、多尿、多食、体重减轻。','FBG≥7.0或OGTT 2h≥11.1或HbA1c≥6.5%。','二甲双胍为基础，逐步升级治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds010','痛风','内分泌疾病','TF','嘌呤代谢紊乱致高尿酸血症，尿酸盐结晶沉积引起的关节炎。','急性关节炎（常首发第一跖趾关节）。','高尿酸血症+典型关节炎+关节液尿酸盐结晶。','急性期NSAIDs/秋水仙碱，缓解期降尿酸。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds011','甲亢','内分泌疾病','JK','甲状腺激素分泌过多。最常见：Graves病。','心悸、多汗、手抖、消瘦。','TSH↓ + FT3/FT4↑。','抗甲状腺药物±放射性碘或手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds012','癫痫','神经系统疾病','DX','大脑神经元异常同步放电导致的反复发作性疾病。','突发意识障碍、肢体抽搐等。','临床发作特点+脑电图。','抗癫痫药物，部分可手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds013','脑卒中','神经系统疾病','NZZ','急性脑血管病，分为缺血性（约80%）和出血性。','突发面部不对称、单侧肢体无力。','头颅CT/MRI。','溶栓/取栓+抗血小板+危险因素控制。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds014','肝硬化','消化系统疾病','GYH','慢性肝损伤导致肝纤维化和假小叶形成的终末期肝病。','乏力、黄疸、腹水、肝掌。','影像学+肝功能+肝弹性检测。','病因治疗+并发症管理+肝移植评估。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds015','尿路感染','泌尿系统疾病','NLGR','病原微生物侵入尿路上皮引起的炎症反应。','尿频、尿急、尿痛，可伴发热。','尿常规+尿培养。','抗生素（呋喃妥因/头孢类/喹诺酮类）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds016','心房颤动','心血管疾病','XFCD','最常见的心律失常，心房失去有效收缩。','心悸、胸闷、头晕，部分无症状。','心电图+Holter。','抗凝（DOAC/华法林）+ 心率/节律控制（β阻滞剂/胺碘酮）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds017','心肌梗死','心血管疾病','XJGS','冠状动脉急性闭塞导致心肌缺血坏死。','胸痛>20min、出汗、放射至左肩/下颌。','心电图ST段抬高+肌钙蛋白升高。','急诊PCI+双联抗血小板+他汀+β阻滞剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds018','高脂血症','心血管疾病','GZXZ','血液中脂质（胆固醇、甘油三酯）水平异常升高。','多数无症状。','TC≥5.2或LDL-C≥3.4或TG≥1.7。','他汀为基础，依折麦布/PCSK9i补充。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds019','肺结核','呼吸系统疾病','FJH','结核分枝杆菌引起的慢性传染病。','咳嗽≥2周、咯血、午后低热、盗汗、消瘦。','痰涂片/培养+胸部X线+PPD/IGRA。','2HRZE/4HR方案（异烟肼+利福平+吡嗪酰胺+乙胺丁醇）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds020','肺栓塞','呼吸系统疾病','FSS','内源性或外源性栓子阻塞肺动脉。','突发呼吸困难、胸痛、咯血。','CTPA+D-二聚体。','抗凝（DOAC/低分子肝素→华法林），高危者溶栓。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds021','胰腺炎','消化系统疾病','YXY','胰腺的急性炎症反应。','持续性上腹痛、向背部放射、恶心呕吐。','血淀粉酶/脂肪酶≥3倍正常值+CT。','禁食+补液+镇痛+营养支持。胆源性者ERCP。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds022','炎症性肠病','消化系统疾病','YZXCB','包括克罗恩病和溃疡性结肠炎的慢性肠道炎症。','腹泻、腹痛、便血、体重下降。','结肠镜+病理。','5-ASA/激素/免疫抑制剂/生物制剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds023','甲减','内分泌疾病','JJ','甲状腺激素分泌不足。','乏力、怕冷、体重增加、便秘、记忆力减退。','TSH↑ + FT4↓。','左甲状腺素替代治疗（清晨空腹）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds024','高尿酸血症','内分泌疾病','GNSXZ','嘌呤代谢异常致血尿酸>420μmol/L。','多数无症状，部分进展为痛风。','非同日2次空腹SUA>420。','生活干预（低嘌呤饮食+多饮水）+ 别嘌醇/非布司他/苯溴马隆。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds025','骨质疏松','内分泌疾病','GZSS','骨密度下降、骨微结构破坏。','疼痛、身高变矮、驼背、易骨折。','DXA骨密度T值≤-2.5。','钙+VD+双膦酸盐/地舒单抗/特立帕肽。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds026','帕金森病','神经系统疾病','PJSB','黑质多巴胺神经元变性死亡。','静止性震颤、肌强直、运动迟缓、姿势步态异常。','临床表现为主。','左旋多巴/多巴胺受体激动剂（普拉克索）/MAO-B抑制剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds027','偏头痛','神经系统疾病','PTT','反复发作的中重度搏动性头痛。','单侧搏动性头痛、畏光畏声、恶心。','临床诊断（至少5次发作符合标准）。','急性期：NSAIDs/曲普坦。预防：普萘洛尔/托吡酯/肉毒素。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds028','阿尔茨海默病','神经系统疾病','AECHMB','进行性认知功能障碍和行为损害。','近记忆减退→语言障碍→定向力障碍→人格改变。','认知量表+影像+排除其他原因。','胆碱酯酶抑制剂（多奈哌齐）+NMDA拮抗剂（美金刚）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds029','慢性肾病','泌尿系统疾病','MXSB','肾脏结构或功能异常≥3个月。','早期无症状→乏力、水肿、高血压、贫血。','eGFR<60或蛋白尿≥3个月。','控制血压（ACEI/ARB）+控糖+SGLT2i+低蛋白饮食。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds030','肾结石','泌尿系统疾病','SJS','尿中晶体物质过饱和析出形成结石。','肾绞痛、血尿、恶心呕吐。','B超/CT。','<5mm保守排石（多饮水+α阻滞剂）；>10mm体外碎石/内镜取石。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds031','妊娠期高血压','妇产科疾病','RSQGXY','妊娠20周后出现的血压升高。','高血压±蛋白尿±水肿。','BP≥140/90mmHg（妊娠20周后）。','拉贝洛尔/硝苯地平/甲基多巴，硫酸镁防子痫。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds032','月经失调','妇产科疾病','YJSD','月经周期、经期或经量异常。','周期<21或>35天，经量过多/过少。','病史+妇科检查+激素六项+B超。','根据病因：激素调节/调经/手术治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds033','青光眼','五官科疾病','QGY','眼压升高导致视神经损伤。','早期无症状→视野缺损→视力下降。','眼压测量+眼底检查+视野检查。','降眼压药（噻吗洛尔/拉坦前列素/布林佐胺）+手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds034','中耳炎','五官科疾病','ZEY','中耳黏膜的急性或慢性炎症。','耳痛、听力下降、耳闷胀感，小儿可伴发热。','耳镜检查鼓膜充血/穿孔。','抗生素（阿莫西林/头孢类）+对症止痛。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds035','湿疹','皮肤疾病','SZ','多种内外因素引起的表皮及真皮浅层炎症。','多形性皮损（红斑、丘疹、水疱）+剧烈瘙痒。','临床表现+排除接触性皮炎等。','保湿+外用激素/钙调磷酸酶抑制剂±口服抗组胺药。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds036','银屑病','皮肤疾病','YXB','以红斑鳞屑为特征的慢性炎症性皮肤病。','边界清楚的红斑+银白色鳞屑+点状出血。','临床表现+皮肤镜/病理。','外用激素/维生素D3衍生物+光疗+系统用药（MTX/环孢素/生物制剂）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds037','胃癌','肿瘤疾病','WA','胃黏膜上皮细胞的恶性肿瘤。','上腹痛、食欲减退、消瘦、黑便。','胃镜+病理活检。','手术+化疗+靶向（HER2阳性者曲妥珠单抗）+免疫治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds038','结直肠癌','肿瘤疾病','JZCA','结肠或直肠黏膜上皮的恶性肿瘤。','排便习惯改变、便血、腹痛、消瘦。','结肠镜+病理+CT分期。','手术+化疗（FOLFOX/FOLFIRI）±靶向（贝伐珠单抗/西妥昔单抗）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds039','乳腺癌','肿瘤疾病','RXA','乳腺导管或小叶上皮的恶性肿瘤。','乳房无痛性肿块、皮肤凹陷/橘皮样变。','乳腺B超+钼靶+穿刺活检。','手术+化疗+放疗+内分泌治疗（ER/PR+）+靶向（HER2+）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds040','缺铁性贫血','血液系统疾病','QTXPX','体内铁储备不足导致血红蛋白合成减少。','乏力、头晕、苍白、异食癖。','Hb↓+血清铁↓+铁蛋白↓。','口服铁剂（琥珀酸亚铁）+VC同服促吸收+病因治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds041','大叶性肺炎','呼吸系统疾病','DY','肺炎链球菌等引起的肺大叶急性炎症。','寒战、高热、咳嗽、铁锈色痰、胸痛。','胸部X线大片实变影+血象升高。','青霉素类/头孢类抗感染+对症支持。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds042','稳定型心绞痛','心血管疾病','WD','冠状动脉固定狭窄导致心肌暂时缺血。','劳累后胸骨后压榨样痛，休息/硝酸甘油缓解。','心电图+冠脉CTA/造影。','抗血小板+β阻滞剂+他汀+硝酸酯类。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds043','风湿性心瓣膜病','心血管疾病','FS','风湿热导致心脏瓣膜永久性结构损害。','心悸、气短、心衰症状。','心脏超声。','预防风湿热复发（青霉素）+抗凝+瓣膜置换。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds044','感染性心内膜炎','心血管疾病','GR','病原微生物感染心内膜和瓣膜。','发热、心脏杂音、栓塞表现。','血培养+Duke标准+心脏超声。','长程杀菌性抗生素+必要时手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds045','支气管扩张症','呼吸系统疾病','ZQ','支气管壁破坏导致不可逆性扩张。','慢性咳嗽、大量脓痰、反复咯血。','高分辨率CT(HRCT)。','气道清洁+抗感染+止血+必要时手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds046','间质性肺病','呼吸系统疾病','JJ','肺泡壁和周围组织的弥漫性炎症和纤维化。','进行性呼吸困难、干咳、杵状指。','高分辨率CT+肺功能+肺活检。','激素/免疫抑制剂+抗纤维化+氧疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds047','胃食管反流病','消化系统疾病','WS','胃内容物反流入食管引起症状。','反酸、烧心、胸骨后烧灼感。','PPI试验性治疗+胃镜。','PPI标准剂量+促动力药+生活干预。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds048','功能性消化不良','消化系统疾病','GN','无器质性病变的持续性上消化道症状。','餐后饱胀、早饱、上腹痛。','胃镜排除器质性疾病。','促动力药±PPI+心理干预。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds049','胆囊炎','消化系统疾病','DN','胆囊的急性或慢性炎症。','右上腹痛、发热、Murphy征阳性。','B超+血象。','禁食+抗生素+止痛，必要时手术切除。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds050','胆石症','消化系统疾病','DS','胆道系统内形成结石。','右上腹痛、黄疸、发热。','B超/CT。','无症状观察+有症状腹腔镜胆囊切除。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds051','急性肾损伤','泌尿系统疾病','JX','短时间内肾功能急剧下降。','少尿、水肿、血肌酐升高。','血肌酐↑+尿量↓。','停肾毒性药物+补液+病因治疗+透析。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds052','肾病综合征','泌尿系统疾病','SB','大量蛋白尿导致低蛋白血症和水肿。','大量泡沫尿、水肿、高血脂。','尿蛋白>3.5g/d+血白蛋白<30g/L。','激素/免疫抑制剂+ACEI/ARB+利尿剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds053','前列腺增生','泌尿系统疾病','QL','前列腺良性增生导致尿道梗阻。','排尿困难、夜尿增多、尿线变细。','直肠指检+B超+PSA。','α阻滞剂+5α还原酶抑制剂±手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds054','甲状腺功能亢进','内分泌疾病','JZ','甲状腺激素分泌过多。','怕热、多汗、心悸、消瘦、手抖。','TSH↓+FT3/FT4↑。','甲巯咪唑/丙硫氧嘧啶+放射性碘+手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds055','库欣综合征','内分泌疾病','KX','长期糖皮质激素过多。','向心性肥胖、满月脸、紫纹、高血压。','深夜唾液皮质醇+小剂量地塞米松抑制试验。','手术切除病因+药物(酮康唑/美替拉酮)。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds056','代谢综合征','内分泌疾病','DX','多种代谢异常聚集的症候群。','腹型肥胖+高血压+高血糖+高血脂。','中心性肥胖+任意2项异常。','生活方式干预+全面控制各组分。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds057','癫痫','神经系统疾病','DX','大脑神经元异常放电导致反复发作。','意识丧失、四肢抽搐、口吐白沫。','临床发作+脑电图。','抗癫痫药（丙戊酸钠/卡马西平/左乙拉西坦）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds058','脑出血','神经系统疾病','NC','脑实质内血管破裂出血。','突发剧烈头痛、呕吐、意识障碍。','头颅CT高密度影。','降压+止血+脱水降颅压±手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds059','重症肌无力','神经系统疾病','ZZ','神经肌肉接头传递障碍的自身免疫病。','波动性肌无力，晨轻暮重。','疲劳试验+新斯的明试验+抗体检测。','胆碱酯酶抑制剂+免疫抑制±胸腺切除。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds060','流行性感冒','感染性疾病','LX','流感病毒引起的急性呼吸道传染病。','突发高热、全身酸痛、乏力、干咳。','流感抗原检测+PCR。','奥司他韦/扎那米韦（48h内）+对症。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds061','带状疱疹','感染性疾病','DZ','水痘-带状疱疹病毒再激活。','沿神经分布的簇集水疱+剧痛。','临床表现。','阿昔洛韦/伐昔洛韦+镇痛+神经营养。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds062','泌尿系感染','感染性疾病','MN','泌尿系统各部位的感染性疾病。','尿频、尿急、尿痛、排尿困难。','尿常规+尿培养。','抗生素（呋喃妥因/头孢类/喹诺酮类）。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds063','感染性腹泻','感染性疾病','GR','病原微生物引起的腹泻。','腹泻、呕吐、腹痛、发热。','便常规+便培养。','补液+益生菌+必要时抗生素/蒙脱石。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds064','带状疱疹后遗神经痛','皮肤疾病','DZ','带状疱疹皮损愈合后持续神经痛。','烧灼样、针刺样持续性疼痛。','疱疹病史+神经体检。','加巴喷丁/普瑞巴林+利多卡因贴片+TCA。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds065','真菌性皮肤病','皮肤疾病','ZJ','皮肤癣菌和酵母菌感染。','环形红斑、脱屑、瘙痒。','真菌镜检+培养。','外用抗真菌药（克霉唑/特比萘芬）±口服。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds066','类风湿关节炎','风湿免疫疾病','LF','以滑膜炎为特征的慢性自身免疫病。','对称性小关节肿痛、晨僵>30min。','RF/抗CCP抗体+影像学。','DMARDs（甲氨蝶呤为基础）+生物制剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds067','系统性红斑狼疮','风湿免疫疾病','XT','多系统受累的自身免疫病。','面颊蝶形红斑、关节痛、多系统损害。','ANA+抗dsDNA抗体+临床表现。','激素+免疫抑制剂±生物制剂。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds068','强直性脊柱炎','风湿免疫疾病','QZ','以骶髂关节和脊柱附着点炎为主的慢性炎症。','炎性腰痛（休息加重、活动减轻）。','骶髂关节MRI/CT+HLA-B27。','NSAIDs+TNFi/IL-17i+康复锻炼。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds069','干燥综合征','风湿免疫疾病','GZ','以外分泌腺受损为特征的自身免疫病。','口干、眼干、反复腮腺肿大。','抗SSA/SSB抗体+唇腺活检。','人工泪液/唾液+羟氯喹±免疫抑制。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds070','肺癌','肿瘤疾病','FA','支气管黏膜上皮细胞的恶性肿瘤。','咳嗽、咯血、胸痛、消瘦。','胸部CT+支气管镜+病理。','手术+化疗（培美曲塞/紫杉醇）+靶向+免疫。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds071','肝癌','肿瘤疾病','GA','肝细胞或胆管细胞的恶性肿瘤。','肝区痛、黄疸、腹水、消瘦。','AFP+B超/CT/MRI+病理。','手术+TACE+靶向（索拉非尼/仑伐替尼）+免疫。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds072','前列腺癌','肿瘤疾病','QL','前列腺上皮细胞的恶性肿瘤。','排尿困难、血尿、晚期骨痛。','PSA+直肠指检+活检。','手术+内分泌治疗+放疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds073','再生障碍性贫血','血液系统疾病','ZS','骨髓造血功能衰竭综合征。','贫血、出血、感染。','全血细胞减少+骨髓增生低下。','免疫抑制治疗+造血刺激因子±干细胞移植。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds074','白血病','血液系统疾病','BX','造血干细胞的恶性克隆性疾病。','发热、贫血、出血、骨痛。','血象+骨髓穿刺+流式细胞术。','化疗±靶向治疗±干细胞移植。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds075','多囊卵巢综合征','妇产科疾病','DN','以排卵障碍和高雄激素为特征的内分泌紊乱。','月经稀发、多毛、痤疮、不孕。','月经异常+高雄激素血症+B超。','生活方式干预+二甲双胍+口服避孕药。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds076','子宫内膜异位症','妇产科疾病','ZG','子宫内膜异位种植于子宫外。','痛经、性交痛、不孕。','腹腔镜+病理。','NSAIDs+激素治疗±手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds077','宫颈癌','妇产科疾病','GJ','宫颈上皮细胞的恶性肿瘤。','接触性出血、异常阴道流血。','宫颈细胞学+HPV检测+阴道镜活检。','手术+放疗+化疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds078','勃起功能障碍','男科疾病','BQ','阴茎持续不能达到或维持充分勃起。','勃起困难。','病史+IIEF-5评分。','PDE5i（西地那非/他达拉非）+病因治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds079','男性不育症','男科疾病','NX','婚后1年未避孕未能使配偶妊娠。','无自觉症状。','精液分析+激素检测。','病因治疗+辅助生殖技术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds080','抑郁症','精神心理疾病','YY','持续情绪低落和兴趣减退的心境障碍。','情绪低落、兴趣丧失、自责、睡眠障碍≥2周。','ICD-10/DSM-5标准。','SSRI/SNRI+心理治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds081','焦虑障碍','精神心理疾病','JL','过度担心和紧张的心理障碍。','过度担忧、紧张不安、心悸、失眠。','临床评估+HAMA量表。','SSRI/SNRI+CBT+苯二氮䓬类短期使用。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds082','失眠障碍','精神心理疾病','SM','持续入睡困难或睡眠维持困难。','入睡困难、易醒、早醒≥3次/周。','临床评估+睡眠日记。','CBT-I+必要时佐匹克隆/曲唑酮。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds083','白内障','眼科疾病','BN','晶状体透明度下降或混浊。','渐进性无痛性视力下降。','裂隙灯检查。','白内障超声乳化+人工晶体植入。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds084','糖尿病视网膜病变','眼科疾病','TN','糖尿病导致的视网膜微血管病变。','视物模糊、视野缺损。','眼底检查+荧光血管造影。','严格控糖+激光光凝±抗VEGF注射。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds085','过敏性鼻炎','耳鼻喉疾病','GM','特定过敏原引起的I型变态反应。','阵发性喷嚏、清水样涕、鼻痒、鼻塞。','症状+过敏原检测。','鼻用激素+口服抗组胺药+免疫治疗。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds086','慢性鼻窦炎','耳鼻喉疾病','MX','鼻窦黏膜持续超过12周的炎症。','鼻塞、脓涕、面部胀痛、嗅觉减退。','鼻内镜+CT。','鼻用激素+生理盐水冲洗±抗生素±手术。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds087','小儿肺炎','儿科疾病','XE','小儿肺实质急性炎症。','发热、咳嗽、气促、鼻翼煽动。','胸部X线+血象。','抗感染（青霉素/头孢/大环内酯）+对症。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds088','小儿腹泻','儿科疾病','XE','多种原因引起的小儿排便异常。','大便次数增多、性状改变。','便常规。','补液（ORS）+益生菌+蒙脱石±补锌。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds089','过敏性休克','急诊疾病','GM','严重速发型过敏反应导致的休克。','血压下降、呼吸困难、皮疹、意识障碍。','接触过敏原后快速出现的临床表现。','肾上腺素0.3-0.5mg im +补液+激素+抗组胺。') on conflict (id) do nothing;
insert into diseases(id,name,cat,py,description,symptoms,diagnosis,treatment) values('ds090','脓毒症','急诊疾病','ND','感染引起失调的宿主反应导致器官功能障碍。','发热/低体温、心率加快、低血压。','SOFA评分≥2+感染证据。','1h内广谱抗生素+液体复苏+血管活性药。') on conflict (id) do nothing;
...
insert into med_edu(id,cat,drug,py,key_point,detail) values('m001','服药时间',null,'ZJZXSN',null,'至少餐前30分钟服用，与钙剂、铁剂间隔≥4小时。不可与食物同服——食物显著减少吸收。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m002','服药时间',null,'ALLSN',null,'用一大杯白水（非矿泉水）送服，服药后保持上身直立≥30分钟。不可咀嚼或含服。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m003','服药时间',null,'PPIAMLZD',null,'早餐前30-60分钟服用效果最佳。不可与抗酸药同时服用。肠溶片/胶囊必须整粒吞服，不可压碎或咀嚼。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m004','服药时间',null,'TTLXFTTD',null,'胆固醇主要在夜间合成，短半衰期他汀（辛伐他汀、普伐他汀、氟伐他汀）睡前服效果更佳。阿托伐他汀/瑞舒伐他汀可在一天中任何时间服用。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m005','服用方法',null,'ASPLCRP',null,'必须整片吞服，不可压碎、咀嚼或掰开。肠溶衣保护胃黏膜。建议餐后服用以减少胃肠刺激。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m006','服用方法',null,'EJSG',null,'随餐或餐后立即服用可减轻恶心、腹泻等消化道反应。缓释片必须整片吞服。如漏服一剂，想起时尽快补服，但不可同时服用两剂。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m007','服用方法',null,'AKBT',null,'与第一口饭一起嚼碎服用。如果服药后发生低血糖，必须用葡萄糖（而不是蔗糖或普通食物）纠正——阿卡波糖会抑制蔗糖分解。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m008','服用方法',null,'XSGY',null,'心绞痛发作时立即舌下含服1片，不可吞服。5分钟后症状不缓解可重复1次，最多3次。坐位或半卧位含服以防体位性低血压。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m009','不良反应告知',null,'HFL',null,'必须按医嘱定期监测INR。注意任何异常出血：牙龈出血、皮肤瘀斑、黑便、血尿。外伤后止血时间可能延长。饮食中维生素K摄入量需保持稳定（绿叶蔬菜每日量基本不变）。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m010','不良反应告知',null,'ACEIPDPLD',null,'约5-20%患者出现干咳，多为刺激性、夜间加重。通常用药后1周至6个月内出现。如无法忍受，请告知医师更换为ARB类药物。不可擅自停药。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m011','不良反应告知',null,'ADT',null,'• 肺毒性：出现干咳、呼吸困难立即就医
• 皮肤：防晒！暴露部位可能变蓝灰色
• 眼：每6-12个月眼科检查
• 甲状腺：每3-6个月检查甲功
• 肝功能：定期监测肝酶') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m012','不良反应告知',null,'JADL',null,'服用MTX后24小时补充叶酸5mg，可显著减少口腔炎、恶心、肝酶升高等不良反应而不影响疗效。出现口腔溃疡、发热、异常出血立即就医。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m013','特殊人群',null,'RSQAQYY',null,'A级安全：左甲状腺素、叶酸
B级相对安全：青霉素类、头孢类、对乙酰氨基酚、胰岛素
C级权衡：多数降压药、SSRIs
D级有风险：华法林、苯妥英钠、卡马西平、锂盐
X级禁用：异维A酸、他汀类、利巴韦林、沙利度胺') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m014','特殊人群',null,'BRQAQYY',null,'• 安全：青霉素类、头孢类、对乙酰氨基酚、布洛芬、胰岛素
• 慎用：阿司匹林（Reye综合征风险）、四环素类（影响牙齿骨骼）
• 暂停哺乳：甲硝唑（12-24h后恢复）、放射性药物
• 原则：喂奶后立即服药，选择短半衰期药物') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m015','药物储存',null,'YDS',null,'未开封：2-8℃冷藏保存（冰箱冷藏室，不可冷冻！）。
开封后：室温（<25℃）保存，4周内用完。
避免阳光直射和剧烈震荡。
旅行时使用保温袋携带。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m016','药物储存',null,'XSGYP',null,'必须保存在原装棕色瓶中，密封避光。开封后3-6个月失效。随身携带时避免贴身放置（体温加速分解）。药物失效表现：舌下含服无麻刺感。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m017','药物储存',null,'YSJZJ',null,'多数双歧杆菌、乳杆菌制剂需2-8℃冷藏保存，避免高温和潮湿。服用时用<40℃温开水冲服，高温会杀死活菌。与抗生素间隔≥2小时服用。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m018','生活指导',null,'TTL',null,'服药期间避免食用葡萄柚（西柚）及其果汁。葡萄柚抑制CYP3A4，可导致他汀血药浓度升高数倍，增加肌病和肝损伤风险。普通柚子、橙子、柠檬无此影响。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m019','生活指导',null,'TBLJXZ',null,'服用头孢哌酮、头孢曲松、头孢孟多、甲硝唑、呋喃唑酮期间及停药后7天内严禁饮酒和含酒精制品。可能发生双硫仑样反应：面部潮红、头痛、恶心呕吐、心悸，严重者可休克。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m020','生活指导',null,'HFL',null,'• 保持每日绿叶蔬菜（菠菜、西兰花等）摄入量基本不变
• 避免大量摄入蔓越莓汁、银杏、大蒜提取物
• 饮酒需限量（急性大量饮酒增加出血风险）
• 补充任何维生素或中药前咨询医师') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m021','漏服处理',null,'KFBYY',null,'漏服<12小时：立即补服，下次按时服用。
漏服>12小时：立即补服漏掉的药片，继续按时服剩余药片，未来7天内加用屏障避孕法。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m022','漏服处理',null,'KSS',null,'发现漏服后立即补服。如果接近下次服药时间（<2小时），直接跳过漏服的剂量，按原时间服下一次。不可一次服用双倍剂量！') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m023','漏服处理',null,'HFL',null,'当天内发现漏服：立即补服。
次日才发现：跳过漏服的剂量，不可加倍。
连续漏服≥2天：立即联系医师，可能需要重新调整剂量。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m024','药物相互作用',null,'NSAIDSACEI',null,'布洛芬、双氯芬酸等NSAIDs可减弱ACEI/ARB的降压效果，并增加肾功能损害风险。如需长期合用，需密切监测血压和肾功能。对乙酰氨基酚无此相互作用。') on conflict (id) do nothing;
insert into med_edu(id,cat,drug,py,key_point,detail) values('m025','药物相互作用',null,'PPILBGL',null,'奥美拉唑、艾司奥美拉唑抑制CYP2C19酶，减少氯吡格雷活性代谢物生成。建议改用泮托拉唑、雷贝拉唑（影响较小），或直接使用替格瑞洛。') on conflict (id) do nothing;
