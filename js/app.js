...
function showSecuritySettings(){
  ...
  var html =
    ...
    + '<div><div style="font-size:11px;color:var(--text-light);margin-bottom:2px">问题1</div><select id="ss-sq1" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px;margin-bottom:4px">'+q1+'</select><input id="ss-sa1" placeholder="答案" value="'+(u.security_a1||'')+'" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px"></div>'
    + '<div><div style="font-size:11px;color:var(--text-light);margin-bottom:2px">问题2</div><select id="ss-sq2" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px;margin-bottom:4px">'+q2+'</select><input id="ss-sa2" placeholder="答案" value="'+(u.security_a2||'')+'" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px"></div>'
    + '<div><div style="font-size:11px;color:var(--text-light);margin-bottom:2px">问题3</div><select id="ss-sq3" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px;margin-bottom:4px">'+q3+'</select><input id="ss-sa3" placeholder="答案" value="'+(u.security_a3||'')+'" style="width:100%;padding:8px;border-radius:8px;border:1px solid var(--border);font:inherit;font-size:12px"></div>'
