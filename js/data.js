...
const INFUSION_DATA = [
  ...
  { id:'i021', drug:'四环素类 + 含金属离子药物' , py:'四环素类 + 含金属离子药物'},
  { id:'i022', drug:'喹诺酮类 + 含金属离子药物' , py:'喹诺酮类 + 含金属离子药物'},
  { id:'i023', drug:'华法林 + 多种药物' , py:'D'},
  { id:'i024', drug:'PPI + 氯吡格雷' , py:'PPI'},
  { id:'i025', drug:'他汀类 + CYP3A4抑制剂' , py:'CYPA'},
  { id:'i026', drug:'ACEI/ARB + 保钾药' , py:'ACEIARBB'},
  { id:'i027', drug:'甲氨蝶呤 + NSAIDs/磺胺' , py:'ADNSAIDSA'},
  { id:'i028', drug:'地高辛 + 多种药物' , py:'DD'},
  { id:'i029', drug:'锂盐 + NSAIDs/利尿剂' , py:'NSAIDS'},
  { id:'i030', drug:'避孕药 + 酶诱导剂' , py:'BD'},
