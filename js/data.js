...
const DRUG_CATEGORIES = [
  { id:'antimicrobial', name:'抗微生物药', subs:['青霉素类','一代头孢','二代头孢','三代头孢','四代头孢','五代头孢','头霉素类','碳青霉烯类','青霉烯类','单环β-内酰胺类','β-内酰胺酶抑制剂复方','氨基糖苷类','大环内酯类','林可霉素类','四环素类','甘氨酰环素类','氯霉素类','糖肽类','多肽类','环脂肽类','噁唑烷酮类','喹诺酮类','磺胺类','硝基咪唑类','硝基呋喃类','磷霉素类','利福霉素类','抗分枝杆菌药','抗真菌药','抗病毒药','抗寄生虫药'] },
...
const DRUGS = [
  ...
  { id:'d002', name:'头孢克肟胶囊', py:'TBKWJN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药', indications:'适用于敏感菌所致的呼吸道感染、泌尿道感染、胆道感染、中耳炎等。' },
  ...
  { id:'d011', name:'头孢曲松钠', py:'TBQSN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药', indications:'用于敏感菌所致的下呼吸道感染、泌尿道感染、腹腔感染、败血症、脑膜炎等。' },
  ...
  { id:'d031', name:'头孢呋辛酯片', py:'TBFXZP', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'用于敏感菌所致的呼吸道、泌尿道、皮肤软组织感染等。手术预防用药。' },
  ...
  { id:'d097', name:'头孢氨苄胶囊（一代）', py:'TBABJN', category:'抗微生物药', subcategory:'一代头孢', type:'处方药', indications:'敏感G+菌所致轻中度感染：咽炎、扁桃体炎、皮肤软组织感染。' },
  { id:'d098', name:'头孢拉定胶囊（一代）', py:'TBLDJN', category:'抗微生物药', subcategory:'一代头孢', type:'处方药', indications:'与头孢氨苄类似，对抗G+菌作用强于G-菌。' },
  { id:'d099', name:'头孢丙烯片（二代）', py:'TBBXP', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'敏感菌所致呼吸道、鼻窦、皮肤软组织感染。口服二代头孢。' },
  { id:'d100', name:'注射用头孢替安（二代）', py:'ZSYTBTA', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'G+菌及部分G-菌感染：肺炎、胆道感染、腹膜炎、术后感染。' },
  { id:'d101', name:'注射用头孢西丁（头霉素类）', py:'ZSYTBXD', category:'抗微生物药', subcategory:'头霉素类', type:'处方药', indications:'需氧/厌氧菌混合感染：腹盆腔感染、坏死性筋膜炎。手术预防用药。' },
  { id:'d102', name:'注射用头孢他啶（三代）', py:'ZSYTBTD', category:'抗微生物药', subcategory:'三代头孢', type:'处方药', indications:'铜绿假单胞菌及G-菌重症感染：脓毒症、肺炎、复杂性尿路感染。' },
  { id:'d103', name:'注射用头孢哌酮舒巴坦（三代复方）', py:'ZSYTBPTSBT', category:'抗微生物药', subcategory:'三代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'多重耐药G-菌感染：铜绿假单胞菌、鲍曼不动杆菌、肺炎克雷伯菌。' },
  { id:'d104', name:'头孢地尼胶囊（三代口服）', py:'TBDNJN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药', indications:'敏感菌所致呼吸道/耳鼻喉/皮肤软组织感染。口服三代头孢。' },
  { id:'d105', name:'头孢泊肟酯片（三代口服）', py:'TBBWZP', category:'抗微生物药', subcategory:'三代头孢', type:'处方药', indications:'呼吸道感染/泌尿生殖道感染/皮肤软组织感染。口服三代头孢。' },
  { id:'d106', name:'注射用头孢吡肟（四代）', py:'ZSYTBBW', category:'抗微生物药', subcategory:'四代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'多重耐药菌重症感染：ESBL产酶菌、铜绿假单胞菌。中枢神经系统感染。' },
  ...
  // ═══ 头孢一代补充 ═══
  { id:'d140', name:'注射用头孢唑林钠（一代）', py:'ZSYTBZLN', category:'抗微生物药', subcategory:'一代头孢', type:'处方药', indications:'手术预防用药金标准。G+菌感染：蜂窝织炎、肺炎、尿路感染、败血症。' },
  { id:'d141', name:'头孢羟氨苄片（一代）', py:'TBQABP', category:'抗微生物药', subcategory:'一代头孢', type:'处方药', indications:'敏感G+菌所致轻中度感染：咽炎、扁桃体炎、皮肤软组织感染。口服一代。' },
  // ═══ 头孢二代补充 ═══
  { id:'d142', name:'头孢呋辛钠注射液（二代）', py:'TFXNZSY', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'手术预防用药、G+/G-菌感染：肺炎、腹腔感染、尿路感染。注射二代。' },
  { id:'d143', name:'头孢呋辛酯片（二代口服）', py:'TFXZP', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'呼吸道/泌尿道/皮肤软组织感染。注射序贯口服治疗。' },
  { id:'d144', name:'头孢克洛干混悬剂（二代/儿童）', py:'TBKLGHXJ', category:'抗微生物药', subcategory:'二代头孢', type:'处方药', indications:'儿童呼吸道/耳鼻喉/泌尿道感染。口服二代，适合儿童服用。' },
  // ═══ 头孢三代补充 ═══
  { id:'d145', name:'注射用头孢曲松钠（三代）', py:'ZSYTBQSN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药（限制级）', indications:'G-菌重症感染：脑膜炎、脓毒症、腹腔感染、手术预防。长半衰期三代头孢。' },
  { id:'d146', name:'注射用头孢噻肟钠（三代）', py:'ZSYTBSN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药（限制级）', indications:'G-菌重症感染：脑膜炎、腹腔感染、败血症、下呼吸道感染。' },
  { id:'d147', name:'注射用头孢哌酮钠（三代）', py:'ZSYTBPN', category:'抗微生物药', subcategory:'三代头孢', type:'处方药（限制级）', indications:'G-菌感染及胆道感染为主。主要经胆汁排泄。注意凝血功能。' },
  // ═══ 头孢四代补充 ═══
  { id:'d148', name:'注射用盐酸头孢吡肟（四代）', py:'ZSYYSTBBW', category:'抗微生物药', subcategory:'四代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'ESBL产酶G-菌重症感染、中性粒细胞减少伴发热经验治疗。' },
  { id:'d149', name:'注射用头孢匹罗（四代）', py:'ZSYTBPL', category:'抗微生物药', subcategory:'四代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'多重耐药G-菌重症感染：脓毒症、肺炎。对肠杆菌科活性优于三代。' },
  // ═══ 头孢五代 ═══
  { id:'d150', name:'注射用头孢洛林酯（五代）', py:'ZSYTBLRZ', category:'抗微生物药', subcategory:'五代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'MRSA所致社区获得性肺炎和皮肤软组织感染。唯一抗MRSA头孢。' },
  { id:'d151', name:'注射用头孢洛林（五代）', py:'ZSYTBL', category:'抗微生物药', subcategory:'五代头孢', type:'处方药（特殊使用级）', tag:'高危', indications:'MRSA和MDR G-菌混合感染。CAP和cSSTI。五代头孢。' },
  // ═══ 碳青霉烯类补充 ═══
...
// ═══ 指南数据 ═══
const GUIDELINES = [
  { id:'g001', title:'中国高血压防治指南 2024', system:'心血管', year:'2024' , py:'中国高血压防治指南 2024'},
  { id:'g002', title:'心力衰竭诊疗指南 2023', system:'心血管', year:'2023' , py:'心力衰竭诊疗指南 2023'},
  { id:'g003', title:'中国血脂管理指南 2023', system:'心血管', year:'2023' , py:'中国血脂管理指南 2023'},
  { id:'g004', title:'抗血小板治疗中国专家共识', system:'心血管', year:'2023' , py:'B'},
  { id:'g005', title:'社区获得性肺炎诊治指南', system:'呼吸', year:'2023' , py:'D'},
  { id:'g006', title:'COPD诊治指南 2024', system:'呼吸', year:'2024' , py:'COPD'},
  { id:'g007', title:'支气管哮喘防治指南', system:'呼吸', year:'2023' , py:'C'},
  { id:'g008', title:'消化性溃疡诊疗规范', system:'消化', year:'2023' , py:'消化性溃疡诊疗规范'},
  { id:'g009', title:'中国2型糖尿病防治指南', system:'内分泌', year:'2023' , py:'B'},
  { id:'g010', title:'痛风诊疗指南', system:'内分泌', year:'2023' , py:'痛风诊疗指南'},
  { id:'g011', title:'质子泵抑制剂临床应用指南', system:'消化', year:'2023' , py:'BC'},
  { id:'g012', title:'围手术期抗菌药物预防指南', system:'感染', year:'2023' , py:'围手术期抗菌药物预防指南'},
  { id:'g013', title:'华法林抗凝治疗中国专家共识', system:'血液', year:'2023' , py:'华法林抗凝治疗中国专家共识'},
  { id:'g014', title:'慢性疼痛药物治疗指南', system:'神经', year:'2023' , py:'慢性疼痛药物治疗指南'},
  { id:'g015', title:'Hp根除治疗全国专家共识', system:'消化', year:'2023' , py:'HPC'},
  { id:'g016', title:'骨质疏松诊疗指南', system:'内分泌', year:'2023' , py:'骨质疏松诊疗指南'},
  { id:'g017', title:'心房颤动抗凝治疗指南', system:'心血管', year:'2023' , py:'D'},
  { id:'g018', title:'肾性贫血诊疗指南', system:'血液', year:'2023' , py:'肾性贫血诊疗指南'},
  { id:'g019', title:'化疗止吐指南', system:'肿瘤', year:'2023' , py:'化疗止吐指南'},
  { id:'g020', title:'糖皮质激素临床应用指导原则', system:'内分泌', year:'2023' , py:'CD'},
  { id:'g021', title:'碳青霉烯类抗菌药物临床应用专家共识', system:'感染', year:'2023' , py:'C'},
  { id:'g022', title:'喹诺酮类抗菌药物临床应用指导意见', system:'感染', year:'2023' , py:'CD'},
  { id:'g023', title:'β-内酰胺类抗菌药物皮肤试验指导原则', system:'感染', year:'2023' , py:'AD'},
  { id:'g024', title:'中国心力衰竭诊断和治疗指南', system:'心血管', year:'2023' , py:'D'},
  { id:'g025', title:'抗血栓药物围手术期管理专家共识', system:'血液', year:'2023' , py:'抗血栓药物围手术期管理专家共识'},
  { id:'g026', title:'卒中二级预防抗血小板治疗指南', system:'神经', year:'2023' , py:'B'},
  { id:'g027', title:'非酒精性脂肪性肝病诊疗指南', system:'消化', year:'2023' , py:'B'},
  { id:'g028', title:'慢性乙型肝炎防治指南', system:'消化', year:'2023' , py:'慢性乙型肝炎防治指南'},
  { id:'g029', title:'维生素D及其类似物临床应用共识', system:'内分泌', year:'2023' , py:'DC'},
  { id:'g030', title:'静脉血栓栓塞症防治指南', system:'呼吸', year:'2023' , py:'静脉血栓栓塞症防治指南'},
  { id:'g031', title:'直接口服抗凝药临床合理应用指南', system:'血液', year:'2023' , py:'C'},
  { id:'g032', title:'抗血小板药物临床应用中国专家共识', system:'血液', year:'2023' , py:'BC'},
  { id:'g033', title:'口服降糖药物临床应用专家共识', system:'内分泌', year:'2023' , py:'C'},
  { id:'g034', title:'化疗药物临床应用管理规范', system:'肿瘤', year:'2023' , py:'C'},
  ...
  // ═══ 2026年新增条目 ═══
  { id:'g136', title:'重组人粒细胞集落刺激因子临床应用管理中国专家共识（2026版）', system:'肿瘤', year:'2026' },
  { id:'g137', title:'肝损伤药物目录及合理用药专家共识', system:'药学', year:'2026' },
  { id:'g138', title:'中国多民族人群精准用药研究价值与策略专家共识', system:'药学', year:'2026' },
  { id:'g139', title:'低分子肝素临床应用中国专家共识', system:'血液', year:'2026' },
  ...
  { id:'g145', title:'肿瘤患者药学监护分级标准中国专家共识', system:'肿瘤', year:'2026' },
...
const HEALTH_EDU = [
  ...
  { id:'h023', cat:'生活指导', py:'JY', title:'服药期间必须禁酒的药物清单', content:'为确保安全，服用或注射以下药物期间及停药后一段时间内，**必须严格禁酒**。其核心机制是这些药物会抑制肝脏中的**乙醛脱氢酶**，导致酒精代谢产生的"乙醛"无法分解而在体内蓄积，从而引发中毒反应，即"双硫仑样反应"。这种反应的发生与个人酒量无关，严重时可致命。\n\n### 1. 抗菌药物\n这是引发双硫仑样反应最主要、最常见的一类药物。特别是头孢菌素类中的**头孢哌酮**，其反应发生率最高。\n\n| 药物类别 | 代表药物 |\n| :--- | :--- |\n| **头孢菌素类** | 头孢哌酮、头孢曲松、头孢孟多、头孢替安、头孢美唑、头孢米诺、拉氧头孢、头孢唑林、头孢氨苄、头孢克洛等 |\n| **硝基咪唑类** | 甲硝唑、替硝唑、奥硝唑 |\n| **硝基呋喃类** | 呋喃妥因、呋喃唑酮 |\n| **其他** | 氯霉素、酮康唑、异烟肼（抗结核）、磺胺类（如复方新诺明）等 |\n\n> **注意**：并非只有带"头孢"字样的药物才危险。例如，常用于治疗牙痛、妇科感染的甲硝唑等，同样会引发严重反应。\n\n### 2. 降血糖药物\n该类药物的主要风险在于与酒精同服会诱发严重的低血糖，症状（如头晕、心慌、出汗）与醉酒相似，极易被忽视而延误抢救，可能导致不可逆的神经系统损伤。\n\n*   **磺酰脲类**：格列本脲、格列美脲、格列齐特、格列吡嗪等。\n*   **双胍类**：二甲双胍等。\n*   **其他**：胰岛素等。\n\n### 3. 镇静催眠及抗精神类药物\n酒精本身会抑制中枢神经系统，与此类药物同服会产生叠加效应，导致过度镇静，出现**嗜睡、呼吸抑制、昏迷甚至死亡**。\n\n*   **苯二氮䓬类**：地西泮（安定）、阿普唑仑、氯硝西泮等。\n*   **其他**：苯巴比妥、佐匹克隆、抗抑郁药（如舍曲林、氟西汀）、抗精神病药、抗癫痫药、第一代抗组胺药（如氯苯那敏）等。\n\n### 4. 解热镇痛及其他药物\n虽然这类药物通常不直接引起双硫仑样反应，但与酒精同服会显著增加肝损伤和消化道出血的风险。\n\n*   **对乙酰氨基酚**（常见于多种复方感冒药中）：与酒精同服会显著增加肝毒性风险。\n*   **非甾体抗炎药**：布洛芬、阿司匹林、双氯芬酸等，与酒精同服会加重胃黏膜损伤，增加胃溃疡和消化道出血的风险。\n*   **其他**：**华法林**（抗凝药）与酒精合用可能增加出血风险，或导致药效不稳定。\n\n### 核心建议与安全间隔期\n\n*   **安全原则**："**吃药不喝酒，喝酒不吃药**"是最根本、最安全的原则。\n*   **安全间隔期**：为确保安全，通常建议**服药期间及停药后至少7天内**避免接触任何酒精。同时，饮酒后如需用药，也建议**至少间隔3天**。部分药物（如甲硝唑）或对于儿童等特殊人群，安全间隔期可能需要延长至2周或以上。\n*   **警惕"隐形酒精"**：需注意一些不含酒精但可能诱发反应的物品，如**藿香正气水、酒心巧克力、腐乳、醉虾醉蟹，甚至某些漱口水或外用酒精**。' },
  { id:'h024', cat:'生活指导', py:'JZGKCYHSJ', title:'服药期间禁止高空作业或驾驶的药物', content:'某些药物会影响中枢神经系统，导致嗜睡、头晕、视力模糊、反应迟钝等，在服药期间从事高空作业、驾驶车辆或操作精密仪器可能带来严重安全风险。\n\n### 1. 镇静催眠药\n*   苯二氮䓬类：地西泮（安定）、阿普唑仑、氯硝西泮、劳拉西泮等\n*   Z-drugs：佐匹克隆、唑吡坦、右佐匹克隆\n*   巴比妥类：苯巴比妥等\n\n### 2. 抗组胺药（抗过敏药）\n*   **第一代抗组胺药**（嗜睡作用明显）：氯苯那敏（扑尔敏）、苯海拉明、赛庚啶、异丙嗪\n*   第二代/三代抗组胺药影响较小，但部分人仍可能出现嗜睡\n\n### 3. 抗抑郁药及抗精神病药\n*   选择性5-羟色胺再摄取抑制剂（SSRI）：初期可能出现嗜睡\n*   三环类抗抑郁药：阿米替林、多塞平等\n*   抗精神病药：奥氮平、喹硫平、利培酮等\n\n### 4. 镇痛药\n*   **阿片类镇痛药**：吗啡、可待因、曲马多、羟考酮、芬太尼等\n*   部分非甾体抗炎药可能引起头晕\n\n### 5. 降压药\n*   某些降压药（尤其是初期或调整剂量时）可能引起头晕、低血压\n*   α受体阻滞剂：特拉唑嗪、多沙唑嗪等\n\n### 6. 抗癫痫药\n*   卡马西平、苯妥英钠、丙戊酸、托吡酯等\n\n### 7. 肌肉松弛剂\n*   氯唑沙宗、乙哌立松等\n\n### 8. 降糖药\n*   胰岛素或口服降糖药过量可能导致低血糖，出现头晕、乏力、意识模糊\n\n### 核心建议\n\n*   **用药前咨询**：开始服用任何新药前，询问是否会影响驾驶或操作能力\n*   **观察期**：首次服药或调整剂量后，至少观察3-7天，确认无嗜睡等不良反应后再驾驶\n*   **标签提醒**：注意药品说明书中的"服药后不得驾驶机、车、船、从事高空作业、机械作业及操作精密仪器"警示\n*   **酒精叠加**：服药期间饮酒会显著加重嗜睡和反应迟钝' }
];
...
const GUIDE_SYSTEMS = [
  ...
  { system:'血液', icon:'🩸', items:GUIDELINES.filter(g=>g.system==='血液') },
...
- 登录后可修改昵称和密码
- 勾选"记住密码"可永不过期免登录
- 若没有账号，请联系管理员添加（本站暂不开放自助注册）
- 忘记密码时，点击 **「🔑 找回密码」**，输入用户名后通过密保问题验证即可重置
- 密保问题可在登录后在"我的→密码与密保"中随时修改
- 每日最多通过找回密码重置3次，超出请次日再试

## 二、首页
- 🔍 搜索框：输入药品名/疾病名/指南关键词，按回车搜索。支持多关键词（空格分隔）、拼音首字母、不区分大小写
- 💬 状态栏左侧站内信按钮，未读消息红点提示
- 📱 卡片入口：药品分类、疾病分类、指南法规、药品对比、用药科普、输液配伍、我的收藏
- 最近浏览：自动记录查看过的内容，点击快速跳转

## 三、分类检索（药品·疾病）
- 药品分类标签：按14大类浏览
- 每种药品标注使用级别：非限制级、限制级、特殊使用级
- 疾病分类标签：含定义、症状、诊断、治疗原则+关联药品+关联指南
- 分类可折叠手风琴，支持搜索

## 四、指南法规
- 按系统分组（肿瘤、心血管、神经、呼吸等），单列布局，每组可折叠手风琴
- 支持全文搜索+拼音首字母搜索，搜索时自动展开匹配分类
- 每条指南可查看详情，含原文链接

## 五、药品详情与对比
- 完整药品信息（适应症/禁忌/不良反应/用法用量/储存/相互作用）
- 来源标记：📦系统数据 / 📝用户编辑，帮助识别数据来源
- 配伍禁忌关联：详情页底部显示该药品相关配伍信息
- 说明书：点击弹窗查看完整说明书原文
- 个人备注功能（仅自己可见，200字上限）
- 🧺 **对比篮**：最多可加入5种药品并排对比7个项目

## 六、用药科普
- 合并用药教育+科普教育，按次级分类双列扁平手风琴展示
- 🗣️ 用药教育 / 📖 科普教育图标区分类型
- 支持拼音首字母搜索

## 七、输液配伍
- 分类浏览 + 🔍 多药查询（逗号或空格分隔多个药品）
- 输入时自动补全药名，支持拼音首字母搜索
- 最近搜索快捷入口，点一下直接查
- 搜索结果每条可收藏⭐，查询可收藏⭐（收藏后在"我的→收藏"中可一键查询）
- 配伍查询工具本身也可收藏⭐（输液页折叠面板标题旁）

## 八、收藏功能
- 所有类型内容均可收藏：药品❤️/指南⭐/疾病⭐/科普⭐/用药教育⭐/计算工具⭐
- 配伍查询结果及查询工具均可收藏⭐
- 功能页面可收藏：后台管理⭐/使用帮助⭐/更新日志⭐
- 在"我的→⭐收藏"中集中查看所有收藏，支持搜索
- 收藏实时同步到服务器，换浏览器不丢失
...
## 十、系统与帮助
- 📦 数据概览：查看当前系统各类数据总量
- 📋 更新日志：了解每次更新内容（管理员可编辑）
- 📖 使用帮助：完整使用手册（管理员可编辑）
- 💾 数据管理：管理员可导出/导入数据备份
- 📊 浏览统计：查看今日登录人数+热门TOP20

## 九、我的
- 昵称修改、密码与密保设置
- 内容管理：管理员可编辑6类数据（药品/指南/用药科普/配伍/疾病）
- 编辑记录与审核：所有编辑操作可追溯，管理员可查看待审核内容
- 用户管理：管理员可新增/编辑/删除用户，重置密码
- 使用帮助、免责声明
...
## 一、账号管理
- 管理员账号（walkman0097）：拥有全部权限，包括内容管理、编辑、导出/导入数据、用户管理
- 编辑账号（user001-user004）：拥有内容增删改权限、编辑按钮，**无导出/导入数据权限**
- 普通用户（user005+）：仅只读浏览权限，无内容管理入口
- 所有账号初始密码随机生成，首次登录后建议修改
- 勾选"记住密码"可永不过期免登录
- **用户管理**：管理员可在"我的→用户管理"中新增/编辑/删除用户，并可一键 **重置密码**（生成随机密码并自动复制）
- 普通用户可在登录页自行 **注册新账号**（需填写用户名+邮箱+3个密保问题）
- 忘记密码时可通过 **找回密码** 功能（邮箱+密保验证）自助重置，每日限3次

## 二、内容管理（我的 → 内容管理）
管理员和编辑可增删改以下内容：
- 💊 药品管理 — 新增/编辑/删除药品信息（220种药品，含分级标注）
- 📋 指南管理 — 管理指南条目（34条指南 + 8部法规）
- 📖 科普管理 — 编辑科普教育内容
- 💉 配伍管理 — 编辑输液配伍数据
- 🦠 疾病管理 — 编辑疾病详情（128种疾病）

### 内容管理搜索
- 在内容管理页顶部有 **搜索栏**，输入关键词可实时过滤所有标签页内容（药品/指南/科普/配伍/疾病）
- 搜索范围包括：名称、分类、子类、适应症、标题等
- 支持200ms自动防抖，输入即搜

## 三、密码安全（v1.2.0）
- 所有密码已升级为 **SHA256 哈希加密**存储，管理员也无法查看原文密码
- 编辑用户时密码显示 **[已加密]**，不可修改，只能通过"🔑重置密码"生成新密码
- 用户修改密码、找回密码、管理员重置密码均自动哈希存储
- 首次登录时旧明文密码自动升级为哈希

## 四、编辑审核（v1.2.0）
- 编辑者(user001~004)修改内容后进入 **待审核** 状态
- 管理员(walkman0097)在"我的→编辑记录与审核"中查看待审核条目
- 审核操作：**通过**（同步到服务器）/ **退回** / **忽略** / **稍后**
- 已通过的编辑自动同步到 Supabase

## 五、跨浏览器同步（v1.2.0）
- 所有用户数据实时同步到服务器，换浏览器登录自动拉取
- 包括：昵称/密码/密保/收藏/备注/站内信/浏览记录
- 内容编辑/用户管理/站内信/编辑记录/最近浏览全部同步
- 启用版本检测（v1.2.0），发现新版本自动刷新

## 六、后台管理（v1.2.0）
- 后台管理分为 **内容管理** 和 **用户管理** 两个手风琴卡片
- 两个卡片默认折叠，用户管理仅 walkman0097 可见
- 其他管理员/编辑者只有"内容管理"卡片

### 自定义内容
- 新增/编辑的自定义内容保存在本地浏览器中（localStorage）
- 刷新页面后自动生效
- 所有管理员的自定义数据独立维护

## 三、内容编辑
- 在任何药品/指南/法规/疾病/科普/配伍详情页，管理员和编辑可见"编辑"按钮（页面顶部）
- 点击编辑直接进入修改表单
- 法规内容（药品管理法等）为内置数据，不可直接编辑；可根据需要新增自定义法规条目
- 所有编辑操作自动记录在"我的 → 编辑记录"中

## 四、数据备份
- 仅 walkman0097 拥有 **导出数据到文件** 和 **从文件导入数据** 功能
- 定期导出备份建议
