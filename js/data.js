...
## 一、账号管理
- 管理员账号（walkman0097）：拥有全部权限，包括内容管理、编辑、推送到仓库、导出/导入数据
- 编辑账号（user001-user004）：拥有内容增删改权限、编辑按钮、推送到仓库，**无导出/导入数据权限**
...
## 四、数据同步（推送到仓库）
- 所有管理员和编辑在"我的 → 导出"页面可见 **「☁️ 同步到 GitHub 仓库」** 按钮
- 点击可同步自定义数据到远程仓库
- ⚠️ 注意：推送将覆盖远程仓库中对应的自定义数据文件，请谨慎操作
- 仅walkman0097拥有 **导出数据到文件** 和 **从文件导入数据** 功能
