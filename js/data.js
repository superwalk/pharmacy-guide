...
const DISEASES = [
  ...
  { id:'ds002', cat:'呼吸系统疾病', name:'COPD', py:'COPD', desc:'慢性阻塞性肺疾病，以持续气流受限为特征的常见呼吸系统疾病。主要病因：吸烟、空气污染。', symptoms:'慢性咳嗽、咳痰、进行性呼吸困难。', diagnosis:'肺功能FEV1/FVC<0.7。', treatment:'戒烟+支气管扩张剂（LABA/LAMA）+吸入激素（频繁急性加重者）。' },
  { id:'ds003', cat:'呼吸系统疾病', name:'支气管哮喘', py:'ZQGXC', desc:'以慢性气道炎症为特征的异质性疾病。特征：可变性气流受限。', symptoms:'反复发作性喘息、胸闷、咳嗽。', diagnosis:'可变气流受限证据+典型症状。', treatment:'按GINA阶梯方案，ICS为基础控制药物。' },
  ...
  { id:'ds005', cat:'心血管疾病', name:'心力衰竭', py:'XLSJ', desc:'各种心脏结构/功能异常导致心室充盈或射血能力受损的临床综合征。', symptoms:'呼吸困难、乏力、水肿。', diagnosis:'BNP/NT-proBNP升高+心脏超声LVEF评估。', treatment:'新四联：ARNI+β-blocker+MRA+SGLT2i。' },
  ...
  { id:'ds009', cat:'内分泌疾病', name:'2型糖尿病', py:'2型TNB', desc:'胰岛素抵抗和/或分泌不足导致的慢性高血糖。', symptoms:'多饮、多尿、多食、体重减轻。', diagnosis:'FBG≥7.0或OGTT 2h≥11.1或HbA1c≥6.5%。', treatment:'二甲双胍为基础，逐步升级治疗。' },
  ...
  { id:'ds012', cat:'神经系统疾病', name:'癫痫', py:'XX', desc:'大脑神经元异常同步放电导致的反复发作性疾病。', symptoms:'突发意识障碍、肢体抽搐等。', diagnosis:'临床发作特点+脑电图。', treatment:'抗癫痫药物，部分可手术。' },
  ...
  { id:'ds016', cat:'心血管疾病', name:'心房颤动', py:'X房颤动', desc:'最常见的心律失常，心房失去有效收缩。', symptoms:'心悸、胸闷、头晕，部分无症状。', diagnosis:'心电图+Holter。', treatment:'抗凝（DOAC/华法林）+ 心率/节律控制（β阻滞剂/胺碘酮）。' },
  ...
  { id:'ds018', cat:'心血管疾病', name:'高脂血症', py:'GZX症', desc:'血液中脂质（胆固醇、甘油三酯）水平异常升高。', symptoms:'多数无症状。', diagnosis:'TC≥5.2或LDL-C≥3.4或TG≥1.7。', treatment:'他汀为基础，依折麦布/PCSK9i补充。' },
  ...
  { id:'ds022', cat:'消化系统疾病', name:'炎症性肠病', py:'Y症XCB', desc:'包括克罗恩病和溃疡性结肠炎的慢性肠道炎症。', symptoms:'腹泻、腹痛、便血、体重下降。', diagnosis:'结肠镜+病理。', treatment:'5-ASA/激素/免疫抑制剂/生物制剂。' },
  { id:'ds023', cat:'内分泌疾病', name:'甲减', py:'JJ', desc:'甲状腺激素分泌不足。', symptoms:'乏力、怕冷、体重增加、便秘、记忆力减退。', diagnosis:'TSH↑ + FT4↓。', treatment:'左甲状腺素替代治疗（清晨空腹）。' },
  { id:'ds024', cat:'内分泌疾病', name:'高尿酸血症', py:'GN酸X症', desc:'嘌呤代谢异常致血尿酸>420μmol/L。', symptoms:'多数无症状，部分进展为痛风。', diagnosis:'非同日2次空腹SUA>420。', treatment:'生活干预（低嘌呤饮食+多饮水）+ 别嘌醇/非布司他/苯溴马隆。' },
  ...
  { id:'ds032', cat:'妇产科疾病', name:'月经失调', py:'YJST', desc:'月经周期、经期或经量异常。', symptoms:'周期<21或>35天，经量过多/过少。', diagnosis:'病史+妇科检查+激素六项+B超。', treatment:'根据病因：激素调节/调经/手术治疗。' },
  ...
  { id:'ds038', cat:'肿瘤疾病', name:'结直肠癌', py:'J直CA', desc:'结肠或直肠黏膜上皮的恶性肿瘤。', symptoms:'排便习惯改变、便血、腹痛、消瘦。', diagnosis:'结肠镜+病理+CT分期。', treatment:'手术+化疗（FOLFOX/FOLFIRI）±靶向（贝伐珠单抗/西妥昔单抗）。' },
...
const DRUGS = [
  ...
  { id:'d020', name:'胰岛素注射液（短效）', en:'Regular Insulin', category:'内分泌系统用药', subcategory:'降糖药', type:'处方药', tag:'高危',
  ...
  { id:'d029', name:'氯硝西泮片', en:'Clonazepam', category:'神经系统用药', subcategory:'镇静催眠药', type:'处方药（精二）', tag:'精二',
  ...
  { id:'d033', name:'美罗培南', en:'Meropenem', category:'抗生素', subcategory:'抗生素', type:'处方药（特殊使用级）', tag:'高危',
  ...
  { id:'d034', name:'万古霉素', en:'Vancomycin', category:'抗生素', subcategory:'抗生素', type:'处方药（特殊使用级）', tag:'高危',
  ...
  { id:'d044', name:'华法林钠片', en:'Warfarin Sodium', category:'血液系统用药', subcategory:'抗凝药', type:'处方药', tag:'高危',
  ...
  { id:'d051', name:'胰岛素（甘精胰岛素）', en:'Insulin Glargine', category:'内分泌系统用药', subcategory:'降糖药', type:'处方药', tag:'高危',
  ...
  { id:'d052', name:'甲氨蝶呤片', en:'Methotrexate', category:'抗肿瘤药', subcategory:'化疗药', type:'处方药', tag:'毒',
  ...
  { id:'d055', name:'别嘌醇片', en:'Allopurinol', category:'解热镇痛药', subcategory:'抗痛风药', type:'处方药', tag:'毒',
  ...
  { id:'d057', name:'普瑞巴林胶囊', en:'Pregabalin', category:'神经系统用药', subcategory:'抗癫痫药', type:'处方药（精二）', tag:'精二',
  ...
  { id:'d061', name:'氯化钾缓释片', en:'KCl SR Tablets', category:'营养支持药', subcategory:'电解质', type:'处方药', tag:'高危',
  ...
  { id:'d065', name:'地高辛片', en:'Digoxin', category:'心血管系统用药', subcategory:'抗心律失常药', type:'处方药', tag:'高危',
  ...
  { id:'d066', name:'胺碘酮片', en:'Amiodarone', category:'心血管系统用药', subcategory:'抗心律失常药', type:'处方药', tag:'高危',
  ...
  { id:'d079', name:'曲马多缓释片', en:'Tramadol SR', category:'解热镇痛药', subcategory:'阿片类', type:'处方药（精二）', tag:'精二',
...
## 一、登录与账号
- 管理员账号：admin，初始密码由管理员设定
- 普通用户：user001~user099，初始密码随机
- 登录后可修改昵称和密码
- 勾选"记住密码"可15天内免登录

## 二、首页
- 🔍 搜索框：输入药品名/疾病名/指南关键词，按回车搜索。支持多关键词（空格分隔）、拼音首字母、不区分大小写
- 📱 卡片入口共7个：药品分类、疾病分类、指南法规、药品对比、用药教育、科普教育、输液配伍、计算工具、我的收藏

## 三、药品库
- 药品分类标签：按14大类浏览（抗微生物、抗肿瘤、心血管、消化、神经、呼吸、内分泌、解热镇痛、皮肤科、男科/泌尿、妇产科、五官科、营养支持、血液系统）
- 疾病分类标签：40种疾病详情（含定义、症状、诊断、治疗原则+关联药品+关联指南）
- 分类可折叠，支持搜索
...
## 十、内容管理
管理员和编辑（user001-004）可增删改所有内容。自定义数据保存在本地。
