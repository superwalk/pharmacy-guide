...
// ═══ 指南数据 ═══
const GUIDELINES = [
  { id:'g001', title:'中国高血压防治指南 2024', system:'心血管系统', year:'2024' },
  { id:'g002', title:'心力衰竭诊疗指南 2023', system:'心血管系统', year:'2023' },
  { id:'g003', title:'中国血脂管理指南 2023', system:'心血管系统', year:'2023' },
  { id:'g004', title:'抗血小板治疗中国专家共识', system:'心血管系统', year:'2023' },
  { id:'g005', title:'社区获得性肺炎诊治指南', system:'呼吸系统', year:'2023' },
  { id:'g006', title:'COPD诊治指南 2024', system:'呼吸系统', year:'2024' },
  { id:'g007', title:'支气管哮喘防治指南', system:'呼吸系统', year:'2023' },
  { id:'g008', title:'消化性溃疡诊疗规范', system:'消化系统', year:'2023' },
  { id:'g009', title:'中国2型糖尿病防治指南', system:'内分泌系统', year:'2023' },
  { id:'g010', title:'痛风诊疗指南', system:'内分泌系统', year:'2023' },
  { id:'g011', title:'质子泵抑制剂临床应用指南', system:'消化系统', year:'2023' },
  { id:'g012', title:'围手术期抗菌药物预防指南', system:'抗感染', year:'2023' },
  { id:'g013', title:'华法林抗凝治疗中国专家共识', system:'血液系统', year:'2023' },
  { id:'g014', title:'慢性疼痛药物治疗指南', system:'神经系统', year:'2023' },
  { id:'g015', title:'Hp根除治疗全国专家共识', system:'消化系统', year:'2023' },
  { id:'g016', title:'骨质疏松诊疗指南', system:'内分泌系统', year:'2023' },
  { id:'g017', title:'心房颤动抗凝治疗指南', system:'心血管系统', year:'2023' },
  { id:'g018', title:'肾性贫血诊疗指南', system:'血液系统', year:'2023' },
  { id:'g019', title:'化疗止吐指南', system:'抗肿瘤', year:'2023' },
  { id:'g020', title:'糖皮质激素临床应用指导原则', system:'内分泌系统', year:'2023' },
  { id:'g021', title:'碳青霉烯类抗菌药物临床应用专家共识', system:'抗感染', year:'2023' },
  { id:'g022', title:'喹诺酮类抗菌药物临床应用指导意见', system:'抗感染', year:'2023' },
  { id:'g023', title:'β-内酰胺类抗菌药物皮肤试验指导原则', system:'抗感染', year:'2023' },
  { id:'g024', title:'中国心力衰竭诊断和治疗指南', system:'心血管系统', year:'2023' },
  { id:'g025', title:'抗血栓药物围手术期管理专家共识', system:'血液系统', year:'2023' },
  { id:'g026', title:'卒中二级预防抗血小板治疗指南', system:'神经系统', year:'2023' },
  { id:'g027', title:'非酒精性脂肪性肝病诊疗指南', system:'消化系统', year:'2023' },
  { id:'g028', title:'慢性乙型肝炎防治指南', system:'消化系统', year:'2023' },
  { id:'g029', title:'维生素D及其类似物临床应用共识', system:'内分泌系统', year:'2023' },
  { id:'g030', title:'静脉血栓栓塞症防治指南', system:'呼吸系统', year:'2023' },
  { id:'g031', title:'直接口服抗凝药临床合理应用指南', system:'血液系统', year:'2023' },
  { id:'g032', title:'抗血小板药物临床应用中国专家共识', system:'血液系统', year:'2023' },
  { id:'g033', title:'口服降糖药物临床应用专家共识', system:'内分泌系统', year:'2023' },
  { id:'g034', title:'化疗药物临床应用管理规范', system:'抗肿瘤', year:'2023' },
  { id:'g035', title:'原发性肝癌诊疗指南（2026年版）', system:'肿瘤', year:'2026' },
  { id:'g036', title:'中国淋巴瘤诊疗指南（2026版）', system:'肿瘤', year:'2026' },
  { id:'g037', title:'CSCO乳腺癌诊疗指南（2026版）', system:'肿瘤', year:'2026' },
  { id:'g038', title:'肺癌常用标志物检测及临床应用专家共识（2026版）', system:'肿瘤', year:'2026' },
  { id:'g039', title:'靶向TROP2的ADC应用于非小细胞肺癌专家共识（2026版）', system:'肿瘤', year:'2026' },
  { id:'g040', title:'中国肝细胞癌经动脉介入治疗临床实践指南（2026版）', system:'肿瘤', year:'2026' },
  { id:'g041', title:'肿瘤化疗导致中性粒细胞减少诊治中国专家共识（2026版）', system:'肿瘤', year:'2026' },
  { id:'g042', title:'基于NGS的肿瘤全景变异检测探针设计专家共识（2026版）', system:'肿瘤', year:'2026' },
  { id:'g043', title:'CACA整体整合诊疗指南：老年肿瘤（2026版）', system:'肿瘤', year:'2026' },
  { id:'g044', title:'CACA指南·血管保护（2026版）', system:'肿瘤', year:'2026' },
  { id:'g045', title:'中国老年患者医学营养治疗指南（2026版）', system:'肿瘤', year:'2026' },
  { id:'g046', title:'经皮冠状动脉介入治疗指南（2025）', system:'心血管', year:'2025' },
  { id:'g047', title:'智能可穿戴设备在心血管领域应用的专家建议（2026）', system:'心血管', year:'2026' },
  { id:'g048', title:'QT间期延长的监测与风险评估专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g049', title:'复发性心包炎临床诊疗专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g050', title:'成人运动康复心血管风险评估与防范专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g051', title:'成人先天性心脏病相关肺动脉高压诊断与治疗指南（2026）', system:'心血管', year:'2026' },
  { id:'g052', title:'低镁血症诊断与治疗专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g053', title:'急性主动脉夹层合并灌注不良综合征诊断和治疗专家共识（2026版）', system:'心血管', year:'2026' },
  { id:'g054', title:'介入相关主动脉损伤的预防与处理策略专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g055', title:'女性心律失常诊治专家共识（2026）', system:'心血管', year:'2026' },
  { id:'g056', title:'神经调控治疗癫痫临床指南（2026版）', system:'神经', year:'2026' },
  { id:'g057', title:'慢性意识障碍患者综合康复和无创神经调控促醒治疗中国专家共识（2026）', system:'神经', year:'2026' },
  { id:'g058', title:'神经外科手术机器人辅助脑深部电刺激手术专家共识（2026版）', system:'神经', year:'2026' },
  { id:'g059', title:'植入式脑机接口临床应用路径管理中国专家共识（2026版）', system:'神经', year:'2026' },
  { id:'g060', title:'中国卒中患者社区-居家全周期体适能康复路径2026专家共识', system:'神经', year:'2026' },
  { id:'g061', title:'急性缺血性卒中再灌注治疗医疗质量评价与改进专家建议（2026）', system:'神经', year:'2026' },
  { id:'g062', title:'高血压性脑出血重症管理专家共识（2026版）', system:'神经', year:'2026' },
  { id:'g063', title:'癫痫共病焦虑、抑郁诊治专家共识（2026版）', system:'神经', year:'2026' },
  { id:'g064', title:'视网膜中央动脉阻塞神经介入专家共识（2026版）', system:'神经', year:'2026' },
  { id:'g065', title:'中国慢性呼吸疾病呼吸康复指南（2026版）', system:'呼吸', year:'2026' },
  { id:'g066', title:'小气道病变与慢性气道疾病临床诊疗专家共识（2026年）', system:'呼吸', year:'2026' },
  { id:'g067', title:'免疫抑制宿主重症肺炎诊断与治疗专家共识（2026）', system:'呼吸', year:'2026' },
  { id:'g068', title:'成人原发性纤毛运动障碍诊治专家共识（2025年版）', system:'呼吸', year:'2025' },
  { id:'g069', title:'GOLD 2026（慢阻肺全球倡议2026版报告）', system:'呼吸', year:'2026' },
  { id:'g070', title:'消化道重建术后ERCP专家共识（2026版）', system:'消化', year:'2026' },
  { id:'g071', title:'中国胆汁酸性腹泻临床管理专家共识（2026版）', system:'消化', year:'2026' },
  { id:'g072', title:'中国成人短肠综合征诊疗专家共识（2026版）', system:'消化', year:'2026' },
  { id:'g073', title:'老年人消化不良的评估与处理中国专家共识（2026版）', system:'消化', year:'2026' },
  { id:'g074', title:'老年人胆囊结石诊断和治疗专家共识（2026版）', system:'消化', year:'2026' },
  { id:'g075', title:'儿童发热全程管理专家共识（2026版）', system:'儿科', year:'2026' },
  { id:'g076', title:'抗流感病毒药物儿科合理应用专家共识（2026版）', system:'儿科', year:'2026' },
  { id:'g077', title:'新一代四环素类抗生素儿科应用临床实践指南（2026版）', system:'儿科', year:'2026' },
  { id:'g078', title:'儿童白血病微小残留病监测与临床应用指南（2026）', system:'儿科', year:'2026' },
  { id:'g079', title:'儿童淋巴结肿大临床诊治专家共识（2026）', system:'儿科', year:'2026' },
  { id:'g080', title:'儿童青少年1型糖尿病自我管理教育与支持专家共识（2026版）', system:'儿科', year:'2026' },
  { id:'g081', title:'遗传性妇科肿瘤高风险人群管理指南（2026年版）', system:'妇产科', year:'2026' },
  { id:'g082', title:'辅助生殖技术静脉血栓栓塞症风险评估及预防中国专家共识（2026年版）', system:'妇产科', year:'2026' },
  { id:'g083', title:'子宫颈上皮内瘤变2级（CIN2）管理中国专家共识（2026版）', system:'妇产科', year:'2026' },
  { id:'g084', title:'孕产妇血液管理专家共识（2026年指南，贫血管理）', system:'妇产科', year:'2026' },
  { id:'g085', title:'妊娠合并胸主动脉疾病诊断与治疗专家共识（2026）', system:'妇产科', year:'2026' },
  { id:'g086', title:'中国宫颈机能不全诊断与治疗专家共识（2026修订版）', system:'妇产科', year:'2026' },
  { id:'g087', title:'骨科手术部位感染创面预防与治疗的专家共识（2026版）', system:'骨科', year:'2026' },
  { id:'g088', title:'膝骨关节炎阶梯治疗专家共识2026版', system:'骨科', year:'2026' },
  { id:'g089', title:'智能传感动态引导技术在骨科手术应用的专家共识（2026版）', system:'骨科', year:'2026' },
  { id:'g090', title:'前交叉韧带过顶位重建技术中国专家共识（2025年版）', system:'骨科', year:'2025' },
  { id:'g091', title:'骨质疏松性桡骨远端骨折中西医协同诊疗临床实践指南（2026版）', system:'骨科', year:'2026' },
  { id:'g092', title:'中国老年2型糖尿病防治临床指南（2026年版）', system:'内分泌', year:'2026' },
  { id:'g093', title:'2型糖尿病胰岛β细胞功能评估与保护临床专家共识（2026版）', system:'内分泌', year:'2026' },
  { id:'g094', title:'老年人群维生素D营养评估及补充中国专家共识（2026.03）', system:'内分泌', year:'2026' },
  { id:'g095', title:'痛风石损害程度分级和外科治疗的多学科专家共识（2025版）', system:'内分泌', year:'2025' },
  { id:'g096', title:'发热待查诊治专家共识（2026版）', system:'感染', year:'2026' },
  { id:'g097', title:'腹腔感染常见耐药菌诊治与防控中国专家共识（2026版）', system:'感染', year:'2026' },
  { id:'g098', title:'抗病原体临床应用中国专家指南（2026版）', system:'感染', year:'2026' },
  { id:'g099', title:'结核病宿主来源生物标志物的诊断应用专家共识（2026.01）', system:'感染', year:'2026' },
  { id:'g100', title:'抗结核药治疗药物监测临床应用专家共识(2025年更新版)', system:'感染', year:'2025' },
  { id:'g101', title:'我国动脉炎性前部缺血性视神经病变诊断和治疗专家共识（2026）', system:'眼科', year:'2026' },
  { id:'g102', title:'围手术期应用胃肠外直接凝血酶抑制剂的专家共识（2026）', system:'药学', year:'2026' },
  { id:'g103', title:'骨科大手术患者静脉血栓栓塞症预防专家共识（2026）', system:'药学', year:'2026' },
  { id:'g104', title:'腔镜机器人手术体位安置专家共识（2026版）', system:'腔镜机器人', year:'2026' },
  { id:'g105', title:'机器人辅助胃癌手术助手职责专家共识（2026版）', system:'腔镜机器人', year:'2026' },
  { id:'g106', title:'成人烧伤患者气道灌洗疗法专家共识（2026版）', system:'其他', year:'2026' },
  { id:'g107', title:'中成药防治泛血管疾病及其靶器官损害的专家共识', system:'其他', year:'2026' },
  { id:'g108', title:'保湿剂在特应性皮炎管理中的合理应用专家共识（2026版）', system:'其他', year:'2026' },
  { id:'g109', title:'肝细胞癌伴肺转移多学科诊治专家共识（2026版）', system:'其他', year:'2026' },
  { id:'g110', title:'阴道微生态评价临床检验与结果报告规范化专家共识（2026.02.28）', system:'其他', year:'2026' },
  { id:'g111', title:'2026 ACC/AHA/AACVPR血脂异常管理指南', system:'心血管', year:'2026' },
  { id:'g112', title:'2026 ESC心力衰竭指南', system:'心血管', year:'2026' },
  { id:'g113', title:'2026 ESC心血管疾病合并慢性肾脏病指南', system:'心血管', year:'2026' },
  { id:'g114', title:'2026 ESC心脏康复指南', system:'心血管', year:'2026' },
  { id:'g115', title:'2026 ESC心肌梗死指南', system:'心血管', year:'2026' },
  { id:'g116', title:'2026 ESC/EAS脂蛋白(a)指南', system:'心血管', year:'2026' },
  { id:'g117', title:'2026 AHA改善心血管健康饮食指南', system:'心血管', year:'2026' },
  { id:'g118', title:'NCCN中枢神经系统肿瘤指南（2026.V1）', system:'肿瘤', year:'2026' },
  { id:'g119', title:'2026 NCS危重成人癫痫持续状态神经预后指南', system:'神经', year:'2026' },
  { id:'g120', title:'2025 AASM成人阻塞性睡眠呼吸暂停住院评估管理指南', system:'神经', year:'2025' },
  { id:'g121', title:'2025 ASPN外周神经刺激慢性疼痛神经系统疾病应用共识', system:'神经', year:'2025' },
  { id:'g122', title:'2025 ABN自身免疫性重症肌无力管理指南（更新版）', system:'神经', year:'2025' },
  { id:'g123', title:'AA基于血液的生物标志物阿尔茨海默病诊断应用指南', system:'神经', year:'2026' },
  { id:'g124', title:'2025 RANO/EANO PET成像胶质瘤临床应用建议（更新版）', system:'神经', year:'2025' },
  { id:'g125', title:'2026国际共识：Rasmussen综合征诊断和治疗', system:'神经', year:'2026' },
  { id:'g126', title:'2026 AACE成人2型糖尿病管理流程共识', system:'内分泌', year:'2026' },
  { id:'g127', title:'2025 JSH血压升高和高血压管理指南', system:'心血管', year:'2025' },
  { id:'g128', title:'2025 SOGC原发性痛经诊断与管理指南', system:'妇产科', year:'2025' },
  { id:'g129', title:'2026 Kleefstra综合征国际临床循证指南', system:'其他', year:'2026' },
  { id:'g130', title:'2026 21-羟化酶缺乏症临床管理指南', system:'内分泌', year:'2026' },
  { id:'g131', title:'2026意大利法布里病神经学管理及结局指标共识', system:'神经', year:'2026' },
  { id:'g132', title:'WHO GLP-1药物治疗肥胖症全球指南', system:'内分泌', year:'2026' },
  { id:'g133', title:'医疗机构人工智能应用与治理专家共识（2026版）', system:'其他', year:'2026' },
  { id:'g134', title:'FUTURE-AI医疗保健可信赖可部署AI国际共识指南', system:'其他', year:'2026' },
  { id:'g135', title:'中国器官移植人工智能辅助临床决策专家共识（2026版）', system:'其他', year:'2026' },
];
