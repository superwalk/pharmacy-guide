...
const GUIDELINES = [
  ...
  { id:'g102', title:'围手术期应用胃肠外直接凝血酶抑制剂的专家共识（2026）', system:'药学护理', year:'2026' },
  { id:'g103', title:'骨科大手术患者静脉血栓栓塞症预防专家共识（2026）', system:'药学护理', year:'2026' },
...
const GUIDE_SYSTEMS = [
  ...
  { system:'药学护理', icon:'💊', items:GUIDELINES.filter(g=>g.system==='药学护理') },
